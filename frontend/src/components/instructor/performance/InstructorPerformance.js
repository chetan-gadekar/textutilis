        ...
        <MainLayout>
            <div className="font-poppins h-full max-w-7xl mx-auto px-4">
                ...
                <Collapse in={showFilters}>
                    <div className="p-5 bg-white rounded-2xl border border-gray-100 shadow-sm mb-8 flex flex-col md:flex-row gap-5 items-end">
                        ...
                        <div className="flex-1 w-full">
                            <label className="block text-xs font-semibold text-gray-400 mb-2 uppercase tracking-widest">Filter by Course</label>
                            <select
                        ...
                        <table className="min-w-full divide-y divide-gray-200 border-collapse">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {loading ? (
                                    ...
                                    <tr><td colSpan="5" className="px-6 py-12 text-center text-gray-400 font-light">No records found.</td></tr>
                                ) : (
